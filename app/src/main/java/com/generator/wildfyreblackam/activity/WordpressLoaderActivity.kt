...
import com.generator.wildfyreblackam.adapter.LoaderAdapter
import com.generator.wildfyreblackam.api.WordpressApi
import com.generator.wildfyreblackam.data.CalendarData
import com.generator.wildfyreblackam.data.WordpressData
import com.generator.wildfyreblackam.enum.DownloadStatus
import com.generator.wildfyreblackam.events.TimerEvent
import com.generator.wildfyreblackam.events.UrlLoadedEvent
...
import com.generator.wildfyreblackam.presenter.WordpressPresenterClass
import com.generator.wildfyreblackam.presenter.WordpressView
...
class WordpressLoaderActivity : AppCompatActivity(), WordpressView {
    ...
    private fun setAppTitle() {
        if (totalWordpress == 0 && loadedWordpress == 0) {
            ...
            title = "Loading AM: ${loadedWordpress}/${totalWordpress} post"
        } else {
            title = "Loading AM: ${loadedWordpress}/${totalWordpress} posts"
        }
    }
