...
import com.generator.wildfyreblackspecific.adapter.LoaderAdapter
import com.generator.wildfyreblackspecific.api.WordpressApi
import com.generator.wildfyreblackspecific.data.CalendarData
import com.generator.wildfyreblackspecific.data.WordpressData
import com.generator.wildfyreblackspecific.enum.DownloadStatus
import com.generator.wildfyreblackspecific.events.TimerEvent
import com.generator.wildfyreblackspecific.events.UrlLoadedEvent
...
import com.generator.wildfyreblackspecific.model.Wordpress
import com.generator.wildfyreblackspecific.presenter.WordpressPresenterClass
import com.generator.wildfyreblackspecific.presenter.WordpressView
...
class WordpressLoaderActivity : AppCompatActivity(), WordpressView {
    ...
    private fun setAppTitle() {
        if (totalWordpress == 0 && loadedWordpress == 0) {
            ...
            title = "Loading Specific: ${loadedWordpress}/${totalWordpress} post"
        } else {
            title = "Loading Specific: ${loadedWordpress}/${totalWordpress} posts"
        }
    }
