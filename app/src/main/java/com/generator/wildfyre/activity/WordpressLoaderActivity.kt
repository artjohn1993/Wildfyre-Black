...
class WordpressLoaderActivity : AppCompatActivity(), com.generator.wildfyre.presenter.WordpressView {
    ...
    val presenter = com.generator.wildfyre.presenter.WordpressPresenterClass(this, apiServer)
