...
class WordpressPresenterClass(var view: com.generator.wildfyre.presenter.WordpressView, var api: ApiServices) :
    com.generator.wildfyre.presenter.WordpressPresenter {
